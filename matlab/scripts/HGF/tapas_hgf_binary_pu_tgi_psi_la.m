function [traj, infStates] = tapas_hgf_binary_pu_tgi_psi_la(r, p, varargin)
...
if ~isempty(varargin) && strcmp(varargin{1},'trans');
    p = tapas_hgf_binary_pu_tgi_transp_psi_la(r, p);
end
...
% add tgi trial bias 
u_prev = circshift(u,1); % psi positive when biased towards cold
u(u==0.5& cue == 0 &  u_prev == 0) =  u(u==0.5& cue == 0 &  u_prev == 0) - psi;
u(u==0.5& cue == 0 &  u_prev == 1) =  u(u==0.5& cue == 0 &  u_prev == 1) + psi;
u(u==0.5& cue == 1 &  u_prev == 0) =  u(u==0.5& cue == 1 &  u_prev == 0) + psi;
u(u==0.5& cue == 1 &  u_prev == 1) =  u(u==0.5& cue == 1 &  u_prev == 1) - psi;
