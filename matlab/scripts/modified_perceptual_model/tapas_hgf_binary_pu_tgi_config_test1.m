function c = tapas_hgf_binary_pu_tgi_config_test1
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'hgf_binary_pu_tgi_test1';
...
% la
% Format: scalar.
c.logla1mu = log(0.001);
c.loglasa = 4;

% % psi, bias towards hot for tgi trials
% % Format: scalar.
% c.psimu = 0;
% c.psisa = 0;
...
c.prc_fun = @tapas_hgf_binary_pu_tgi_test1;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @tapas_hgf_binary_pu_tgi_transp_test1;
