function [traj, infStates] = tapas_hgf_binary_pu_tgi_test_2_level(r, p, varargin)
...
% add tgi trial bias 
% u_prev = circshift(u,1); % psi positive when biased towards hot
% u(u==0.5& cue == 0 &  u_prev == 0) =  u(u==0.5& cue == 0 &  u_prev == 0);
% u(u==0.5& cue == 0 &  u_prev == 1) =  u(u==0.5& cue == 0 &  u_prev == 1);
% u(u==0.5& cue == 1 &  u_prev == 0) =  u(u==0.5& cue == 1 &  u_prev == 0);
% u(u==0.5& cue == 1 &  u_prev == 1) =  u(u==0.5& cue == 1 &  u_prev == 1);
