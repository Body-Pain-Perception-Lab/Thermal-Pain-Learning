function [position, ConfTimeStamp, RT, answer] = slideScale(screenPointer, instructionDemo, question, rect, anchors, varargin)
...
while answer == 0
    ...
    InstructionDemoRatings =[instructionDemo '\n \n' question];
    DrawFormattedText(screenPointer, uint8(InstructionDemoRatings), 'center', rect(4)*(scalaPosition - 0.25), TextColour, 65);
