...
Parameters.pa.channels     = 1;%1;            % go for mono as we don't care... 1 = mono; 2 = stereo
Parameters.repetitions                 = 1;

% Beep parameters 
Parameters.beepLenghtSecs    = 0.1;
%Parameters.pa.wavfilename = [ '..' filesep 'helpers' filesep 'audio' filesep filename];
beepSound = MakeBeep(freq,Parameters.beepLenghtSecs,Parameters.pa.freq); % generate beep
...
PsychPortAudio('FillBuffer', Parameters.pa.H, beepSound);

% Start audio playback for 'repetitions' repetitions of the sound data,
% start it immediately (0) and wait for the playback to start, return onset
% timestamp.
t1 = PsychPortAudio('Start', Parameters.pa.H, Parameters.repetitions, 0, 1);
...
WaitSecs(Parameters.beepLenghtSecs);
