 function [cueProbabilityOutput, blockParams, breaks] = createCueProbabilities_TGI(vars)
...
%   1       trial #
%   2       condition           [1, 2, 3, 4, 5]     % 1 cue_0 valid
                                                    % 2 cue_1 valid
                                                    % 3 cue_0 invalid    
                                                    % 4 cue_1 invalid      
                                                    % 5 non-predictive
...
%   4       face gender         [0, 1]
%   5       cue                 [0, 1]
%   6       trial type          [1, 2, 3]           % Valid / Invalid / TGI
%   7       desired prob        
%   8       effective prob
%   9       block volatility    [0, 1]              % 1 volatile, 0 stable
%   10      outcome             [0, 1]              % temp outcome. 0 Cold  or 1 Warm
%   11      predictive/non-predictive trial
%   12     	cue0PredictionSequence [0, 1, 2]        %0 NP, 1 cue_0->Warm, 2 cue_0->Cold
...
% Last edit: 24/06/2021             added marker for reversal blocks
...
cueBlockLength_shortP       = 24;% short predictive block, +/-jitter    || 24, total for 4* short blocks = 144
cueBlockLength_longP        = 60;% long predictive block, +/-jitter     || 60, total for 2* long blocks  = 96
    ...
    if isThisBlockPredictive(thisBlock)         % Predictive block
        ...
        switch predBlockTypes(predLoopCounter)
            case 1  % in this long block, cue zero is predictive of happy
                ...
                thisBlockClass          = 3;        % Predictive long
            ...
            case 3  % in this short block, cue zero is predictive of happy 
                ...
                cue0PredictiveOf        = 1;        % Happy
                thisBlockClass          = 2;        % Predictive short
...
save(fullfile(['sequence']), 'cueProbabilityOutput', 'blockParams', 'breaks');
end