...
To assess the best-fitting model, while accounting for parameter complexity, we compared the 2-level HGF with other well-known reinforcement learning models, such as Rescorla-Wagner, Sutton K1 and Pearce-Hall [@rescorla_theory_1972; @sutton_gain_1995; @li_differential_2011; @zhang_dissociable_2016] using Bayesian model selection  [@daunizeau_vba_2014]. We found that the 2-level HGF outperformed these models. To validate the robustness of our fitted models, we conducted both parameter and model recovery for the models under consideration (see fig. S1-8). Overall, model comparison and cross-validation demonstrated that thermosensory learning is best captured by Bayesian precision-weighted mechanisms that integrate both prediction and estimation uncertainty.
